...
__proxy.csv__:proxy的列表，通过[这篇笔记](http://yingshin.github.io/python/2015/07/31/scrapy-httpproxy/)获取    
...
注意settings.py还有很多其他设置，感兴趣的可以一一了解下，注意在这里也可以定义我们自己的设置，比如PROXY_LIST就是存放代理的文件，生成该文件的方法参考另外一篇[文章](http://yingshin.github.io/python/2015/07/31/scrapy-httpproxy/)。
