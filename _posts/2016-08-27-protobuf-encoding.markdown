...
[上篇文章](http://yingshin.github.io/c/cpp/2016/08/17/protobuf-encode-varint-and-zigzag)介绍了protobuf里整型的编码方式，这篇文章从整体上介绍下pb的编码规则，包括string/bytes/float/double/message等类型的序列化实例以及源码，最后分析下pb向前兼容这个特性的一些细节。
...
接下来介绍下各种类型的序列化过程，每个字段的key的序列化是一致的，先统一介绍下。

### 3. key的序列化

#### 3.1 规则
key的序列化使用了varint编码，在[上一节](http://yingshin.github.io/c/cpp/2016/08/17/protobuf-encode-varint-and-zigzag)也简单介绍了下。
